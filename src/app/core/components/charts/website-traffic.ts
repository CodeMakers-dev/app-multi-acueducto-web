  ...
  <div class="flex justify-between mb-3">
    <div class="flex items-center">
      <div class="flex justify-center items-center">
        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Salto De Bordones</h5>
  ...
  <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
    <div class="grid grid-cols-3 gap-3 mb-2">
      <dl class="bg-orange-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
        ...
        <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">Completas</dd>
      </dl>
  ...
  <div class="grid grid-cols-1 items-center border-t border-gray-200 dark:border-gray-700">
    <div class="flex flex-wrap gap-4 pt-5">
      ...
      <div>
        <button
          id="dateFilterButton"
          data-dropdown-toggle="dateFilterMenu"
        ...
        <div id="dateFilterMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
          <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dateFilterButton">
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Hoy</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Últimos 7 días</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Últimos 30 días</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Personalizado</a></li>
          </ul>
        </div>
      </div>

      <!-- Dropdown: nombre de acueducto -->
      <div>
        <button
          id="acueductoFilterButton"
          data-dropdown-toggle="acueductoFilterMenu"
          data-dropdown-placement="bottom"
          class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 inline-flex items-center dark:hover:text-white"
          type="button">
          Seleccione acueducto
          <svg class="w-2.5 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
          </svg>
        </button>
        <div id="acueductoFilterMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
          <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="acueductoFilterButton">
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pedregal</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Libertad</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Obrero</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Morelia</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Palmar</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cedro</a></li>
            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pitas</a></li>
          </ul>
        </div>
      </div>
  ...
  private getChartOptions(): RadialOptions {
    return {
      ...
      chart: {
        ...
        width: '100%',
        type: 'radialBar',
        sparkline: { enabled: true }, // oculta ejes/ruido cuando está activo :contentReference[oaicite:1]{index=1}
      },
      plotOptions: {
        radialBar: {
          track: { background: '#E5E7EB' }, // track configurable en radialBar options :contentReference[oaicite:2]{index=2}
      ...
      tooltip: {
        enabled: true,
        x: { show: false },
        // si quieres: y: { formatter: (v) => v + '%' }  // :contentReference[oaicite:3]{index=3}
      },
      yaxis: {
        show: false,
